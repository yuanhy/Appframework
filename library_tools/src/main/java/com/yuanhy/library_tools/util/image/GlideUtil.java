...
//    //列表试展位图
//    public static void showimageProductList(Context context, String mediaUrl, ImageView ivOrderPic) {
//
//        try {
//            RequestOptions options = new RequestOptions();//
//            options.placeholder(ivOrderPic.getDrawable());
//            options.error(ivOrderPic.getDrawable());
